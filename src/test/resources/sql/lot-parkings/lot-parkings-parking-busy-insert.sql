...
insert into tb_parking (id, code, status) values (400, 'A-04', 'BUSY');
insert into tb_parking (id, code, status) values (500, 'A-05', 'BUSY');
...
insert into tb_client_has_parking (number_receipt, plate, brand, model, color, date_entry, id_client, id_parking)
    values ('20230315-101600', 'FIT-1020', 'FIAT', 'PALIO', 'VERDE', '2023-03-14 10:15:00', 21, 400);
insert into tb_client_has_parking (number_receipt, plate, brand, model, color, date_entry, id_client, id_parking)
    values ('20230315-101700', 'FIT-1020', 'FIAT', 'PALIO', 'VERDE', '2023-03-14 10:15:00', 22, 500);