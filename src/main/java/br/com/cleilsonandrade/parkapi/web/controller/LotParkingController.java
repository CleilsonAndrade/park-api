...
public class LotParkingController {
	...
	@Operation(summary = "Create a new check-in in parking lot", description = """
			Resource for entering a vehicle into the parking lot\
	...
	@Operation(summary = "Locate a parked vehicle", description = """
			Resource for returning a parked vehicle \
			hair receipt number \
			Request requires use of a 'Bearer token'\
			""", security = @SecurityRequirement(name = "security"), parameters = {
	...
	@Operation(summary = "Checkout operation", description = """
			Resource for leaving a vehicle from the parking lot \
			Request requires use of a 'Bearer token'. Restricted access to Role='ADMIN'\
			""", security = @SecurityRequirement(name = "security"), parameters = {
			@Parameter(in = ParameterIn.PATH, name = "receipt", description = "Receipt number generated by check-in", required = true)
	}, responses = {
	...
	@Operation(summary = "Find client parking records by CPF", description = """
			Find client parking records by CPF\
			Request requires use of a 'Bearer token'. Restricted access to Role='ADMIN'\
			""", security = @SecurityRequirement(name = "security"), parameters = {
	...
	@Operation(summary = "Find authenticated client records", description = """
			Find authenticated client records\
	...
	@Operation(summary = "PDF report with customer parking lots", description = """
			Feature to generate a report with the customer's parking lots\
			Request requires use of a 'Bearer token'. Restricted access to Role='CLIENT\
			""", security = @SecurityRequirement(name = "security"), responses = {
